            ...
            <Form className="daily-report">
                ...
                <div className="daily-report__body">
                    ...
                    <div className="daily-report__item">
                        ...
                        <Field type="number" name="weight1" className="daily-report__input" placeholder="вес (кг)" />

                        <div className="daily-report__label">
                            <p>Вид пайки :</p>
                        </div>
                        <Field type="number" name="weight2" className="daily-report__input" placeholder="вес (кг)" />

                        <div className="daily-report__label">
                            <p>Вид пайки :</p>
                        </div>
                        <Field type="number" name="weight3" className="daily-report__input" placeholder="вес (кг)" />

                        <div className="daily-report__label">
                            <p>Вид пайки :</p>
                        </div>
                        <Field type="number" name="weight4" className="daily-report__input" placeholder="вес (кг)" />
                    ...
                    <div className="daily-report__item">
                        ...
                        <FormikErrorMessage component="div" name="light" className="formik-error-message" />
                        <Field type="text" name="light" className="daily-report__input" />

                        <div className="daily-report__label">
                            <p>Игрушки:</p>
                        </div>
                        <FormikErrorMessage component="div" name="toys" className="formik-error-message" />
                        <Field type="text" name="toys" className="daily-report__input" />

                        <div className="daily-report__label">
                            <p>Ограждения:</p>
                        </div>
                        <FormikErrorMessage component="div" name="fances" className="formik-error-message" />
                    ...
                    <div className="daily-report__item">
                        ...
                        <FormikErrorMessage component="div" name="workActivity" className="formik-error-message" />
                        <Field type="number" name="workActivity" className="daily-report__input" />

                        <div className="daily-report__label">
                            <p>Пищевая активность (%):</p>
                        </div>
                        <FormikErrorMessage component="div" name="foodActivity" className="formik-error-message" />
                        <Field type="number" name="foodActivity" className="daily-report__input" />

                        <div className="daily-report__label">
                            <p>Физическое состояние:</p>
                        </div>
                        <FormikErrorMessage component="div" name="physicalState" className="formik-error-message" />
                        <Field type="text" name="physicalState" className="daily-report__input" />
                    </div>

                    <div className="daily-report__item">
                        <h4 className="daily-report__subtitle">Примечание</h4>
                        <Field name="note" as="textarea" cols="30" rows="10" className="daily-report__textarea"></Field>
                    </div>
                    ...
                    <div className="daily-report__item">
                        ...
                        <FormikErrorMessage component="div" name="responsible" className="formik-error-message" />
                        <Field type="text" name="responsible" className="daily-report__input" />

                        <div className="daily-report__label">
                            <p>Дата:</p>
                        </div>
                        <FormikErrorMessage component="div" name="date" className="formik-error-message" />
